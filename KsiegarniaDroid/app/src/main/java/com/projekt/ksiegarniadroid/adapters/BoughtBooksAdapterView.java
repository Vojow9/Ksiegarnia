...
/**
 * Created by Sebo on 2017-01-30.
 */

public class BoughtBooksAdapterView extends BaseAdapter {

    private final ArrayList<Book> _entries;
    private final Context _context;

    public BoughtBooksAdapterView(ArrayList<Book> _entries, Context _context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.bought_list_item, null);
        }
        ...
        tv = (TextView) convertView.findViewById(R.id.tvPurchasedate);
        tv.setText(entry.getPurchasedate());
